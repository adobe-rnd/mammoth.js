...
function BodyReader(options) {
        ...
        "w:p": function(element) {
            return readXmlElements(element.children)
                .map(function(children) {
                    ...
                    if (properties && properties.runProperties.deleted) {
                        // if entire paragraph was deleted via track-changes, ignore it
                        return null;
                    }
        ...
        "w:pPr": function(element) {
            return readParagraphStyle(element).map(function(style) {
                return {
                    ...
                    runProperties: readRunProperties(element.firstOrEmpty("w:rPr")).value
                };
            });
        },
    ...
    function readTableRow(element) {
        ...
        if (properties.first("w:del")) {
            // if entire row was deleted via track-changes, ignore it
            return emptyResult();
        }
        return readXmlElements(element.children).map(function(children) {
    ...
    function readTableCell(element) {
        return readXmlElements(element.children).map(function(children) {
            ...
            var cell = documents.TableCell(children, {colSpan: colSpan, vAlign: vAlign});
